    ...
    return (
        <div style={{ minHeight: '100vh', display: 'flex', background: '#020617' }}>
            ...
            <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 32, overflowY: 'auto' }}>
                <div className="auth-card gradient-border-top animate-scaleIn" style={{ width: '100%', maxWidth: 420, background: 'rgba(11,17,32,0.6)', backdropFilter: 'blur(20px)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 16, padding: '36px 32px' }}>
                    ...
                    <form onSubmit={handleSignup} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                        ...
                        <div style={{ height: 1, background: 'linear-gradient(90deg, transparent, rgba(124,92,255,0.15), transparent)', margin: '4px 0' }} />
