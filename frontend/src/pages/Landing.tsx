...
import { ArrowRight, Sparkles, Target, Zap, Star, ChevronRight, CheckCircle2, Users, BookOpen, Calculator, BarChart3, MessageSquare, Shield } from 'lucide-react';
...
export default function Landing() {
    return (
        <div style={{ minHeight: '100vh', color: 'white', position: 'relative', background: '#020617' }}>
            ...
            {/* Subtle gradient blobs — less is more */}
            ...
            <nav style={{ position: 'sticky', top: 0, zIndex: 50, borderBottom: '1px solid rgba(255,255,255,0.04)', background: 'rgba(2,6,23,0.8)', backdropFilter: 'blur(16px)' }}>
                <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px', height: 64, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                        <Link to="/login" style={{ fontSize: 13, fontWeight: 500, color: '#94a3b8', padding: '8px 16px', borderRadius: 8 }}>Log in</Link>
                ...
                <div className="hero-grid" style={{ display: 'grid', gridTemplateColumns: '1.1fr 0.9fr', gap: 80, alignItems: 'center', minHeight: 'calc(100vh - 64px)', paddingTop: 40, paddingBottom: 60 }}>
                    ...
                    <div className="hero-left" style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                        ...
                        <div className="hero-cta-row" style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 40 }}>
                            ...
                            <Link to="/login" style={{ fontSize: 14, fontWeight: 500, color: '#94a3b8', display: 'flex', alignItems: 'center', gap: 6 }}>
                    ...
                    <div style={{ position: 'relative' }}>
                        ...
                        <div style={{ position: 'relative', borderRadius: 16, overflow: 'hidden', border: '1px solid rgba(255,255,255,0.06)', background: 'rgba(11,17,32,0.8)', boxShadow: '0 32px 64px -12px rgba(0,0,0,0.6)' }}>
                            {/* Window chrome */}
            ...
            <section style={{ borderTop: '1px solid rgba(255,255,255,0.04)', borderBottom: '1px solid rgba(255,255,255,0.04)', padding: '32px 0', background: 'rgba(255,255,255,0.01)' }}>
                <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 48, flexWrap: 'wrap' }}>
                    {['SRM University', 'VIT Vellore', 'Anna University', 'BITS Pilani', 'Manipal'].map(uni => (
                        <span key={uni} style={{ fontSize: 14, fontWeight: 600, color: '#334155', letterSpacing: '-0.01em' }}>{uni}</span>
                    ))}
                </div>
            </section>
                ...
                <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px' }}>
                    ...
                    <div className="features-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 20 }}>
                        {[
                            ...
                            <div key={i} style={{ padding: 28, borderRadius: 14, border: '1px solid rgba(255,255,255,0.04)', background: 'rgba(255,255,255,0.015)', transition: 'all 0.25s ease' }}>
            ...
            {/* HOW IT WORKS */}
            {/* ═══════════════════════════════════════════ */}
            <section style={{ padding: '80px 0', borderTop: '1px solid rgba(255,255,255,0.04)', background: 'rgba(255,255,255,0.01)' }}>
                <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px' }}>
                    ...
                    <div className="features-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 32 }}>
                        {[
                            ...
                            <div key={i} style={{ textAlign: 'center', padding: '32px 24px' }}>
                                <div style={{ fontSize: 48, fontWeight: 900, color: 'rgba(124,92,255,0.12)', letterSpacing: '-0.04em', marginBottom: 16, lineHeight: 1 }}>{s.step}</div>
            ...
            <footer style={{ borderTop: '1px solid rgba(255,255,255,0.04)', padding: '24px 0' }}>
                <div className="footer-inner" style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    <p style={{ fontSize: 12, color: '#334155' }}>© 2026 GradeForge</p>
                    <div style={{ display: 'flex', gap: 20, fontSize: 12, color: '#334155' }}>
                        <a href="https://github.com/SaravanaSabare/GradeForge" target="_blank" rel="noopener" style={{ transition: 'color 0.2s' }}>GitHub</a>
